...
export const createFalabellaConnector: ConnectorFactory<
  FalabellaConnectorConfig
> = (config) => {
  ...
  const connector: ChannelConnector = {
    ...
    async fetchOrders(
      ...
      throw new Error(
        "NOT_IMPLEMENTED_F6: Falabella Sellercenter orders sync — Phase 6 (optional)",
      );
    },
    ...
    async fetchProducts(
      ...
      throw new Error(
        "NOT_IMPLEMENTED_F6: Falabella Sellercenter products sync — Phase 6 (optional)",
      );
    },
    ...
    async normalizeOrder(
      ...
      throw new Error(
        "NOT_IMPLEMENTED_F6: Falabella order normalization — Phase 6",
      );
    },
    ...
    async normalizeProduct(
      ...
      throw new Error(
        "NOT_IMPLEMENTED_F6: Falabella product normalization — Phase 6",
      );
    },
