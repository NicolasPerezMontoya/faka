...
export default async function UploadWizardPage({ searchParams }: { searchParams: SearchParams }) {
    ...
    <div>
      <header className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1 max-w-2xl">
          El archivo crudo se almacena íntegro y reprocesable. Las filas pasan por el pipeline de matching y
          aparecen en los marts al finalizar.
        </p>
      </header>
